...
public class OwnerParameter {
	...
	@Schema(description = "Type of address proof", example = "Aadhar Card")
	private String addressProofType;

	@Schema(description = "Address proof number", example = "1234-5678-9012")
	private String addressProofNumber;

	@Schema(description = "Flag indicating if address proof is verified", example = "true")
	private boolean addressProofVerified;

	@Schema(description = "Type of identity proof", example = "PAN Card")
	private String identityProofType;

	@Schema(description = "Identity proof number", example = "ABCDE1234F")
	...
	@Schema(description = "Present address of the owner")
	...
	@Schema(description = "Permanent address of the owner")
	...
	// Constructors, Getters and Setters (No changes needed here)
